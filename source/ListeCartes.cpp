...
ListeCartes::ListeCartes() {
   ...
   /*A modifier  :on ne peut pas différencier listeChance[12] et  listeChance[13] avec cette définition*/
   ...
   hautChance=&listeChance[15];
   hautCommunaute=&listeCommunaute[13];
   

}

Carte ListeCartes:: tirageChance() {

   Carte* precedent = hautChance;
   cout<<"CARTE CHANCE : "<<endl
      <<precedent->getDescription();
   hautChance = hautChance->getSuivant();
   return precedent;
   
}

Carte ListeCartes:: tirageCommunaute() {

   Carte* precedent = hautCommunaute;
   cout<<"CARTE COMMUNAUTE : "<<endl
      <<precedent->getDescription();
   hautCommunaute = hautCommunaute->getSuivant();
   return precedent;
